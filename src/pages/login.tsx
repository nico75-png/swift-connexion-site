                ...
                <div className="onecx-auth__social">
                  <button type="button" className="onecx-auth__social-button" aria-label="Connexion avec Google">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                      <path d="M21.35 11.1H12V13.9H18.54C18.01 16.32 15.79 18 12 18C8.13 18 5 14.87 5 11C5 7.13 8.13 4 12 4C13.864 4 15.5 4.7 16.77 5.86L18.79 3.84C17.01 2.2 14.7 1.2 12 1.2C6.7 1.2 2.2 5.7 2.2 11C2.2 16.3 6.7 20.8 12 20.8C17.3 20.8 21.8 16.3 21.8 11C21.8 10.45 21.73 10.02 21.63 9.57L21.35 11.1Z" fill="currentColor" />
                    </svg>
                    Google
                  </button>

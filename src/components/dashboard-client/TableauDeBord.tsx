...
const TableauDeBord = () => {
  ...
  return (
    <section
      ...
      className="rounded-3xl border border-border/40 bg-muted/10 p-6 shadow-sm backdrop-blur-xl xl:p-8"
    >
      <div className="grid gap-6 xl:grid-cols-[240px_minmax(0,1fr)_320px] xl:items-start">
        ...
        <div className="flex flex-col gap-6">
          <header
            ...
            className="flex flex-col gap-4 rounded-3xl bg-background/80 p-6 shadow-sm ring-1 ring-black/5 md:flex-row md:items-center md:justify-between"
          >
            <div>
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center">
              ...
              <div className="flex items-center justify-end gap-2">
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="rounded-full border border-transparent bg-muted/40 text-muted-foreground transition hover:bg-muted"
          ...
          <section
            aria-labelledby="instagram-subscribers"
            className="rounded-3xl bg-background/80 shadow-sm ring-1 ring-black/5"
          >
            <Card className="border-none bg-transparent shadow-none">
              <CardHeader className="flex flex-row items-start justify-between gap-4">
                <div>
                  <CardTitle id="instagram-subscribers" className="text-xl">
          ...
          <div className="grid gap-6 xl:grid-cols-2">
            <section
              aria-labelledby="platform-summary"
              className="rounded-3xl bg-background/80 shadow-sm ring-1 ring-black/5"
            >
              <Card className="border-none bg-transparent shadow-none">
                <CardHeader>
                  <CardTitle id="platform-summary" className="text-xl">
                    Résumé des performances par plateforme
                  </CardTitle>
                  ...
                  <div className="grid gap-4 sm:grid-cols-3">
                    {PLATFORM_SUMMARY.map(platform => (
                      ...
                      >
                        ...
                        <div
                          className="mt-3 h-20 rounded-xl border border-dashed border-muted-foreground/30 bg-background/70"
                          aria-hidden="true"
                        />
                      </div>
                    ))}
            ...
            <section
              aria-labelledby="activity-metrics"
              className="rounded-3xl bg-background/80 shadow-sm ring-1 ring-black/5"
            >
              <Card className="border-none bg-transparent shadow-none">
                <CardHeader>
                  <CardTitle id="activity-metrics" className="text-xl">
                    Récapitulatif des vues et abonnés
                  </CardTitle>
          ...
          <section
            aria-labelledby="planned-events"
            className="rounded-3xl bg-background/80 shadow-sm ring-1 ring-black/5"
          >
            <Card className="border-none bg-transparent shadow-none">
              <CardHeader>
                <CardTitle id="planned-events" className="text-xl">
              ...
              <CardContent>
                <ul className="space-y-4">
                  {PLANNED_EVENTS.map(event => (
                    <li
                      key={event.title}
                      className="flex items-center justify-between gap-4 rounded-2xl border border-muted-foreground/20 bg-muted/10 p-4"
                    >
                      <div>
        ...
        <aside className="space-y-6">
          ...
          >
            <Card className="border-none bg-transparent shadow-none">
              <CardHeader>
                <CardTitle id="account-summary" className="text-xl">
                  Sommaire du compte
                </CardTitle>
          ...
          >
            <Card className="border-none bg-transparent shadow-none">
              <CardHeader>
                <CardTitle id="payments" className="text-xl">
                  Paiements
                </CardTitle>

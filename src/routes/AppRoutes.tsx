  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="se-connecter" element={withGuards(Login)} />
        <Route path="registre" element={withGuards(Register)} />
        <Route path="mot-de-passe-oublie" element={withGuards(ForgotPassword)} />
        ...
        <Route path="dashboard-client/suivi" element={withGuards(DashboardClientSuivi, { requiresAuth: true })} />
        ...
        {/* C - ESPACE ADMIN */}
        <Route path="admin" element={withGuards(DashboardAdmin, { requiresAuth: true, roles: ["admin"] })} />
        <Route path="admin/commandes" element={withGuards(DashboardAdminCommandes, { requiresAuth: true, roles: ["admin"] })} />
        <Route path="admin/chauffeurs" element={withGuards(DashboardAdminChauffeurs, { requiresAuth: true, roles: ["admin"] })} />
        <Route path="admin/clients" element={withGuards(DashboardAdminClients, { requiresAuth: true, roles: ["admin"] })} />
        <Route path="admin/factures" element={withGuards(DashboardAdminFactures, { requiresAuth: true, roles: ["admin"] })} />
        <Route path="admin/statistiques" element={withGuards(DashboardAdminStatistiques, { requiresAuth: true, roles: ["admin"] })} />
        <Route path="admin/messages" element={withGuards(DashboardAdminMessages, { requiresAuth: true, roles: ["admin"] })} />
        <Route path="admin/parametres" element={withGuards(DashboardAdminParametres, { requiresAuth: true, roles: ["admin"] })} />

        {/* Redirections pour rétrocompatibilité */}
        <Route path="login" element={<Navigate to="/se-connecter" replace />} />
        <Route path="register" element={<Navigate to="/registre" replace />} />

    ...
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route
          ...
          element={withGuards(DashboardClientCommandes, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/commandes/nouvelle"
          element={withGuards(DashboardClientCommandeNouvelle, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/commandes/:id"
          element={withGuards(DashboardClientCommandeDetail, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/suivi/:id"
          element={withGuards(DashboardClientSuiviDetail, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/factures"
          element={withGuards(DashboardClientFactures, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/factures/:id"
          element={withGuards(DashboardClientFactureDetail, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/messages"
          element={withGuards(DashboardClientMessages, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/messages/:id"
          element={withGuards(DashboardClientMessageDetail, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/profil"
          element={withGuards(DashboardClientProfil, { requiresAuth: true })}
        />
        <Route
          path="dashboard-client/parametres"
          element={withGuards(DashboardClientParametres, { requiresAuth: true })}
        />

        <Route path="dashboard-admin" element={withGuards(DashboardAdmin, { requiresAuth: true, roles: ["admin"] })} />
        <Route
          path="dashboard-admin/commandes"
          element={withGuards(DashboardAdminCommandes, { requiresAuth: true, roles: ["admin"] })}
        />
        <Route
          path="dashboard-admin/commandes/:id"
          element={withGuards(DashboardAdminCommandeDetail, { requiresAuth: true, roles: ["admin"] })}
        />
        <Route
          path="dashboard-admin/chauffeurs"
          element={withGuards(DashboardAdminChauffeurs, { requiresAuth: true, roles: ["admin"] })}
        />
        <Route
          path="dashboard-admin/clients"
          element={withGuards(DashboardAdminClients, { requiresAuth: true, roles: ["admin"] })}
        />
        <Route
          path="dashboard-admin/clients/:id"
          element={withGuards(DashboardAdminClientDetail, { requiresAuth: true, roles: ["admin"] })}
        />
        <Route
          path="dashboard-admin/factures"
          element={withGuards(DashboardAdminFactures, { requiresAuth: true, roles: ["admin"] })}
        />
        <Route
          path="dashboard-admin/statistiques"
          element={withGuards(DashboardAdminStatistiques, { requiresAuth: true, roles: ["admin"] })}
        />
        <Route
          path="dashboard-admin/messages"
          element={withGuards(DashboardAdminMessages, { requiresAuth: true, roles: ["admin"] })}
        />
        <Route
          path="dashboard-admin/parametres"
          element={withGuards(DashboardAdminParametres, { requiresAuth: true, roles: ["admin"] })}
        />

        <Route path="espace-client" element={<Navigate to="/dashboard-client" replace />} />

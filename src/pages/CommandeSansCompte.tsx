                  ...
                  <aside className="xl:sticky xl:top-24 xl:self-start">
                    <div className="w-full rounded-3xl border border-slate-200/80 bg-white/95 p-4 shadow-[0_18px_45px_-30px_rgba(15,23,42,0.45)] transition-all duration-300 xl:max-w-[320px]">
                      ...
                      <div className="mt-4 space-y-3 text-sm text-slate-600">
                        ...
                        <div className="space-y-2 rounded-3xl border border-emerald-200 bg-emerald-50/80 p-3.5 text-slate-700">
                        ...
                        <Button
                          ...
                          className="w-full rounded-full bg-yellow-400 px-6 py-3 text-sm font-semibold text-slate-900 shadow-lg transition hover:bg-yellow-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400 focus-visible:ring-offset-2"
                        >
                          {isSubmitting ? (

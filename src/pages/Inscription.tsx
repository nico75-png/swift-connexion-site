...
const registrationSchema = z
  .object({
    ...
    username: z
      ...
      .regex(/^[a-zA-Z0-9._-]+$/, "Utilisez uniquement des lettres, chiffres ou ._-"),
    country: z.enum(COUNTRY_VALUES),
    phone: z
      .string()
      .min(8, "Le numéro de téléphone est incomplet."),
    password: z
      .string()
...
const GoogleIcon = () => (
  ...
  >
    <path
      d="M17.64 9.2045C17.64 8.56682 17.5827 7.95295 17.4764 7.36395H9V10.8454H13.8436C13.635 11.9704 13.0009 12.9236 12.0477 13.5613V15.8195H14.9563C16.6581 14.2522 17.64 11.9454 17.64 9.2045Z"
      fill="#4285F4"
    />
    <path
      d="M9 18C11.43 18 13.4677 17.1941 14.9563 15.8195L12.0477 13.5613C11.2418 14.1013 10.2109 14.4209 9 14.4209C6.65591 14.4209 4.67182 12.8377 3.96409 10.71H0.957275V13.0418C2.43818 15.9832 5.48182 18 9 18Z"
      fill="#34A853"
    />
    <path
      d="M3.96409 10.7101C3.78409 10.1701 3.68182 9.59319 3.68182 9.00005C3.68182 8.40691 3.78409 7.83005 3.96409 7.29005V4.95828H0.957273C0.347727 6.17328 0 7.54787 0 9.00005C0 10.4522 0.347727 11.8268 0.957273 13.0419L3.96409 10.7101Z"
      fill="#FBBC05"
    />
    <path
      d="M9 3.57909C10.3214 3.57909 11.5077 4.03318 12.4336 4.92137L15.0218 2.33318C13.4632 0.864545 11.4255 0 9 0C5.48182 0 2.43818 2.01682 0.957275 4.95818L3.96409 7.28996C4.67182 5.16273 6.65591 3.57909 9 3.57909Z"
      fill="#EA4335"
    />
  </svg>
);
...
const Inscription = () => {
  ...
  const selectedCountry = useMemo(
    () => COUNTRY_OPTIONS.find((option) => option.value === watchCountry) ?? COUNTRY_OPTIONS[0],
    [watchCountry],
  );
    ...
    <div className="relative flex min-h-screen flex-col bg-muted/30">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-10 flex items-center justify-between">
          <Link
            to="/"
            className="flex items-center gap-3 rounded-full bg-white/80 px-4 py-2 text-sm font-semibold text-primary shadow-soft transition-smooth hover:text-primary-dark"
          >
          ...
          <span className="hidden text-sm font-semibold uppercase tracking-[0.4em] text-primary/60 md:block">
            sharp. fast.
          </span>
        </div>
            ...
            <div className="flex w-full flex-col justify-between px-6 py-8 sm:px-10 sm:py-12">
              ...
              <div className="mt-8 space-y-8">
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="w-full justify-center gap-3 text-sm font-semibold"
